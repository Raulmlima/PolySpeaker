...
const styles = StyleSheet.create({
  ...
  stageBtnTitle: { fontSize: 16, fontWeight: '700', color: C.text },
  stageBtnTitleOpen: { color: C.accent },
  stageBtnDesc: { fontSize: 12, color: C.textMuted, fontStyle: 'italic', marginTop: 2 },
  ...
  modBtnNumText: { fontSize: 11, fontWeight: '700', color: C.accent },
  modBtnTitle: { fontSize: 14, fontWeight: '700', color: C.text },
  modBtnSub: { fontSize: 11, color: C.textMuted, fontStyle: 'italic', marginTop: 1 },
