...
const styles = StyleSheet.create({
  ...
  errorText: { padding: 24, color: C.text },
  ...
  exitBtnText: { fontSize: 14, color: C.incorrect, fontWeight: '700' },
  progressBar: { height: 6, backgroundColor: C.border, borderRadius: 3, marginHorizontal: 16, overflow: 'hidden' },
  ...
  theoryToggleText: { fontSize: 13, color: C.accent },
  theoryBox: {
    backgroundColor: C.bgAlt, borderLeftWidth: 3, borderLeftColor: C.accent,
    padding: 14, marginBottom: 20, borderRadius: 4,
  },
  theoryLabel: { fontSize: 10, fontWeight: '700', color: C.accent, letterSpacing: 2, marginBottom: 6 },
  ...
  nextBtn: {
    backgroundColor: C.correct, borderRadius: 14,
    paddingVertical: 15, alignItems: 'center', marginBottom: 16,
  },
  nextBtnText: { fontSize: 16, fontWeight: '800', color: '#fff' },
  feedbackBox: { borderRadius: 14, padding: 16, marginBottom: 12 },
  ...
  aiAcceptedNote: { flex: 1, fontSize: 12, color: C.accent, fontStyle: 'italic', marginTop: 2 },
  aiMistakeText: { flex: 1, fontSize: 12.5, color: C.incorrect, lineHeight: 18, marginTop: 1 },
  ...
  variationsBtnText: { fontSize: 13, color: C.accent },
  variation: { fontSize: 14, color: C.text, marginTop: 4, marginLeft: 4 },
  iaBtn: {
  ...
  comingSoonSub: { fontSize: 15, color: C.textMuted, fontStyle: 'italic', marginTop: 6, textAlign: 'center' },
  soonBadge: { marginTop: 16, paddingHorizontal: 14, paddingVertical: 6, borderWidth: 1, borderColor: C.border, borderRadius: 20 },
  soonBadgeText: { fontSize: 13, color: C.textMuted },
  ...
  theoryIntroTitle: { fontSize: 20, fontWeight: '700', color: C.text, marginBottom: 4 },
  theoryIntroSub: { fontSize: 13, color: C.textMuted, fontStyle: 'italic', marginBottom: 14 },
  ...
  theoryIntroBtnText: { fontSize: 16, fontWeight: '700', color: '#fff' },
  ...
  deWarnTitle: { fontSize: 20, fontWeight: '700', color: C.text, marginBottom: 14 },
  deWarnBody: { fontSize: 14, color: C.textMuted, lineHeight: 22, marginBottom: 24 },
  deWarnChars: { fontSize: 22, fontWeight: '700', color: C.text, letterSpacing: 6 },
  deWarnTip: { fontSize: 12, color: C.accent, fontStyle: 'italic' },
  deWarnBtnSettings: {
    borderWidth: 1.5, borderColor: C.accent, borderRadius: 8,
    paddingVertical: 12, alignItems: 'center', marginBottom: 10,
  },
  deWarnBtnSettingsText: { fontSize: 14, color: C.accent, fontWeight: '700' },
  deWarnBtn: { backgroundColor: C.accent, borderRadius: 8, paddingVertical: 14, alignItems: 'center', marginBottom: 10 },
  deWarnBtnText: { fontSize: 15, fontWeight: '700', color: '#fff' },
  deWarnBtnNever: { paddingVertical: 8, alignItems: 'center' },
  deWarnBtnNeverText: { fontSize: 13, color: C.textMuted },
  micSection: { borderTopWidth: 1, borderTopColor: C.border, paddingTop: 12, marginTop: 4, marginBottom: 8 },
  micTitle: { fontSize: 13, fontWeight: '700', color: C.textMuted, marginBottom: 8 },
  ...
  micBtnText: { fontSize: 14, color: C.text },
  micTranscript: { fontSize: 13, color: C.textMuted, fontStyle: 'italic', marginTop: 8, textAlign: 'center' },
  ...
  micResultText: { fontSize: 14, fontWeight: '700', color: C.text },
  micRetryText: { fontSize: 13, color: C.accent, textDecorationLine: 'underline' },
  // Listening exercise
  listenBadge: {
  ...
  listenBadgeText: { fontSize: 10, color: '#8B6F47', letterSpacing: 2, fontWeight: '700' },
  listenInstruction: { fontSize: 16, color: C.text, marginBottom: 20, lineHeight: 24 },
  listenPlayBtn: {
  ...
  listenPlayText: { fontSize: 16, fontWeight: '700', color: '#fff' },
  listenQuestion: { fontSize: 15, color: C.textMuted, marginBottom: 14, fontStyle: 'italic' },
  listenOption: {
  ...
  listenOptionLetter: { fontSize: 15, fontWeight: '700', color: C.accent, minWidth: 20 },
  listenOptionText: { fontSize: 15, color: C.text, flex: 1, lineHeight: 22 },
  ...
  listenFeedbackText: { fontSize: 14, color: C.text, fontWeight: '600' },
});
