...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 15, fontWeight: '700', color: C.text, flex: 1, textAlign: 'center' },
  scroll: { padding: 18 },
  ...
  modNumText: { fontSize: 12, fontWeight: '700', color: C.accent },
  modTitle: { fontSize: 15, fontWeight: '700', color: C.text },
  modSub: { fontSize: 12, color: C.textMuted, fontStyle: 'italic', marginTop: 2 },
  ...
  theoryText: { fontSize: 14, color: C.text, lineHeight: 24 },
  noContentBox: {
    backgroundColor: C.bgAlt, borderRadius: 10, padding: 20,
    borderWidth: 1, borderColor: C.border, marginBottom: 8,
  },
  noContentText: { fontSize: 14, color: C.textMuted, lineHeight: 22, fontStyle: 'italic' },
});
