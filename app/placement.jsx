...
const styles = StyleSheet.create({
  ...
  introLang: { fontSize: 11, color: C.accent, letterSpacing: 2, textTransform: 'uppercase', marginBottom: 12 },
  introTitle: { fontSize: 26, fontWeight: '700', color: C.text, marginBottom: 16, lineHeight: 32 },
  introBody: { fontSize: 15, color: C.textMuted, lineHeight: 24, marginBottom: 28 },
  ...
  infoNum: { fontSize: 24, fontWeight: '700', color: C.accent },
  ...
  diffLabel: { fontSize: 10, color: C.accent, letterSpacing: 2, textTransform: 'uppercase', marginBottom: 10 },
  questionPrompt: { fontSize: 22, fontWeight: '700', color: C.text, lineHeight: 30, marginBottom: 8 },
  questionHint: { fontSize: 13, color: C.textMuted, fontStyle: 'italic', marginBottom: 20 },
  answerInput: {
  ...
  skipBtnText: { fontSize: 14, color: C.textMuted },

  resultScroll: { padding: 24, alignItems: 'center' },
  resultScore: { fontSize: 64, fontWeight: '700', color: C.accent, marginTop: 8 },
  resultScoreSub: { fontSize: 14, color: C.textMuted, marginBottom: 28 },
  resultLevelBox: {
  ...
  resultLevelLabel: { fontSize: 10, color: C.accent, letterSpacing: 2, textTransform: 'uppercase', marginBottom: 6 },
  resultLevel: { fontSize: 32, fontWeight: '700', color: C.accent, marginBottom: 8 },
  resultLevelDesc: { fontSize: 14, color: C.text, textAlign: 'center', lineHeight: 20 },
  scoreBreakdown: { width: '100%', marginBottom: 28 },
  breakdownRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 12, gap: 10 },
  breakdownLabel: { fontSize: 13, color: C.text, width: 110 },
  ...
  breakdownScore: { fontSize: 13, color: C.textMuted, width: 28, textAlign: 'right' },
