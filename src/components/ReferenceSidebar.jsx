...
const styles = StyleSheet.create({
  ...
  headerTitle: { fontSize: 18, color: C.text, fontWeight: '600', letterSpacing: 0.5 },
  closeBtn: { padding: 6 },
  ...
  sectionTabText: { fontSize: 13, color: C.textMuted, whiteSpace: 'nowrap' },
  ...
  tableCell: { fontSize: 14, color: C.text, flex: 1 },
  ...
  noteText: { fontSize: 13, color: C.accent, lineHeight: 19 },
  ...
  falsePT: { fontSize: 14, color: C.textMuted, fontStyle: 'italic' },
  falseArrow: { fontSize: 14, color: C.border },
  falseES: { fontSize: 15, fontWeight: '700', color: C.accent },
  falseNote: { fontSize: 12, color: C.textMuted, marginTop: 2, marginLeft: 2 },
  tenseRow: {
    flexDirection: 'row',
    alignItems: 'center',
    paddingHorizontal: 4,
  ...
  tenseName: { fontSize: 15, fontWeight: '700', color: C.text },
  tenseDesc: { fontSize: 12, color: C.textMuted, marginTop: 2 },
  ...
  verbInfinitive: { fontSize: 15, fontWeight: '700', color: '#fff' },
  verbMeaning: { fontSize: 12, color: 'rgba(255,255,255,0.8)', fontStyle: 'italic' },
  ...
  verbPronoun: { fontSize: 13, color: C.textMuted, width: 100 },
  verbForm: { fontSize: 14, fontWeight: '600', color: C.text },
});
